...
function make_gp($arr,$path,$x_dat,$t_dat,$dat_file_array,$min_max,$username,$frame_delay,$script_start,$amperage,$seq_duration,$show_frame)
{
	...
	//	printf ("<h2><a href=\"make_lor.php?base=$base?full_path=$full_path?frame_delay=$frame_delay?member_id=$member_id?seq_duration=$seq_duration?sequencer=lors2?pixel_count=$pixel_count\">Click here to make LOR S2 pr S3 (*.lms) sequencer files</a></h2>\n");
	/*printf ("<h2><a href=\"make_lor.php?base=$base?full_path=$full_path?frame_delay=$frame_delay?member_id=$member_id?seq_duration=$seq_duration?sequencer=lor_lcb?pixel_count=$pixel_count\">Click here to make LOR S2 or S3(*.lcb) sequencer files</a></h2>\n");*/
	//	printf ("<h2><a href=\"make_lsp.php?base=$base?full_path=$full_path?frame_delay=$frame_delay?member_id=$member_id?seq_duration=$seq_duration?sequencer=lsp2?pixel_count=$pixel_count\">Click here to make LSP 2.0 sequencer files (Not yet implemented)</a></h2>\n");
