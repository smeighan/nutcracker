...
$seq_number=0;
$icon_array=array('ball','bear-n-wagon','bike','blocks','christmas-tree','drum',
'Halloween-1','Halloween-3','Halloween-7','USFlag1','USFlag2');
$c=count($icon_array);
echo "<pre>";
for($i=0;$i<$c;$i++)
{
...
if(!isset($seq_duration)) $seq_duration=5;
if(!isset($frame_delay)) $frame_delay=100;
if(!isset($username)) $username='f';
$amperage=array();
$x_dat_base = $base . ".dat";
