	...
	<ul id="sddm">
		...
		<li><a href="../admin/admin.php" onmouseover="mopen('m7')" onmouseout="mclosetime()">Admin</a>
			<div id="m7" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
				...
				<a href="../effects/generate_gallery_gifs.php">Rebuild the Effect Gallery on your Local Install of Nutcracker</a>
				...
				<a href="../effects/sql2xml.php">Export your data</a>
				<a href="../effects/sql2xml.php?mode=import">Import your data</a>
			</div>
		</li>
