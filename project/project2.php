...
if (isset($type)) {
	...
	if (isset($SelectFile)) {
		...
		$sql = "SELECT model_name, song_name, artist, frame_delay, username, last_update_date, last_compile_date FROM project_target WHERE project_id=".$project_id;
		$result=nc_query($sql);
...
<th>Commands</th>
<?php
	$sql = "SELECT song_name, artist, frame_delay FROM project2 WHERE username='$username' ORDER BY song_name";
	//echo "$sql <br />";
	$result = nc_query($sql);
	$cnt=0;
	...
	<td><a href="project.php?type=2&username='<?php echo $username?>'&song_name='<?php echo $song_name?>'&artist='<?php echo $artist?>'"><img src="../images/edit.png">Edit</a>&nbsp;&nbsp;&nbsp;<a href="project.php?type=3&username='<?php echo $username?>'&song_name='<?php echo $song_name?>'&artist='<?php echo $artist?>'"><img src="../images/delete.png">Remove</a></td>
</tr>
<?php		
	}
	if ($cnt == 0) {
...
<p />
<a href="project.php?type=1">Add a Song to Sequence</a><br />
</body>
</html>